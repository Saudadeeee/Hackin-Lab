...
if (isset($_GET['clear'])) {
    setcookie('redirect_lab_progress', '', time() - 3600, '/');
...
<head>
    ...
    <title>Submit Flag — Open Redirect Lab</title>
...
<div class="submit-page">
    ...
    <div class="completion-banner">
        <h2>&#x1F3C6; Lab Complete!</h2>
        <p>You have found all 10 flags. Excellent work — you've demonstrated mastery of open-redirect bypass techniques.</p>
    </div>
    <?php endif; ?>
    ...
    <div class="progress-section">
        ...
        <div class="flags-list">
            ...
            $levelTitles = [
                ...
                3  => 'Prefix Allowlist Bypass',
                4  => 'Substring Allowlist Bypass',
                5  => 'Backslash Normalization',
                6  => 'Userinfo (@) Host Spoof',
                7  => 'Encoded Slash Bypass',
                8  => 'Dangerous Scheme Redirect',
                9  => 'CRLF Header Injection',
                10 => 'Multi-Layer Filter Bypass',
            ];
            for ($i = 1; $i <= 10; $i++):
