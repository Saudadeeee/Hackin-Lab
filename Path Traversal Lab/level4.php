...
if (isset($_GET['file'])) {
    ...
    $file    = str_replace('../', '', $file);   // "Secure" — removes ../
...
<head>
    ...
    <title>Level 4 - str_replace Bypass | Path Traversal Lab</title>
    <link rel="stylesheet" href="css/styles.css">
</head>
<body>
<div class="header">
    <div>
        <h1>Level 4 &mdash; Bypass Single str_replace('../')</h1>
        <p>Medium &bull; Non-recursive str_replace — nested sequences survive</p>
    </div>
...
<span class="vuln-line"><span class="php-variable">$file</span> = <span class="php-function">str_replace</span>(<span class="php-string">'../'</span>, <span class="php-string">''</span>, <span class="php-variable">$file</span>);   <span class="php-comment">// "Secure" — removes ../</span></span>
<span class="vuln-line"><span class="php-variable">$content</span> = <span class="php-function">file_get_contents</span>(<span class="php-string">'/var/www/html/files/'</span> . <span class="php-variable">$file</span>);  <span class="php-comment">// VULNERABLE</span></span>
...
<span class="php-keyword">?&gt;</span></code>
            ...
            <div style="margin-top:1rem; font-size:0.85rem; color:var(--text-muted); line-height:1.7;">
                ...
                <code>str_replace('../', '', $file)</code> removes every occurrence of <code>../</code>
                in a <strong>single pass</strong>. It does not loop. If you embed <code>../</code>
                <em>inside</em> a longer sequence, what remains after the single-pass removal?<br><br>
                Trace <code>....//</code>: positions 3&ndash;5 match <code>../</code>, they are removed,
                leaving <code>../</code>.<br><br>
                <strong style="color:var(--text);">Goal:</strong>
                Read <code>/var/secret/level4_flag.txt</code>
            </div>
        </div>
        ...
        <div class="challenge-panel">
            <h3>Challenge</h3>
            <div class="scenario">
                <strong>Scenario:</strong> A developer replaced <code>../</code> with an empty string
                using <code>str_replace()</code>, believing this prevents directory traversal.
                <code>str_replace()</code> is non-recursive — a crafted input survives the filter.
            </div>
            ...
            <form method="GET" action="level4.php">
                <div class="form-group">
                    ...
                    <input type="text" id="file" name="file" class="form-control"
                           placeholder="e.g. ....//....//....//....//var/secret/level4_flag.txt"
            ...
            <?php if ($flagFound): ?>
            <div class="message success">Flag captured! The nested traversal bypass succeeded.</div>
    ...
    <div class="navigation">
        <span style="color:var(--text-muted); font-size:0.85rem;">Level 4 / 10</span>
        <a href="level3.php" class="prev-link">&larr; Previous</a>
