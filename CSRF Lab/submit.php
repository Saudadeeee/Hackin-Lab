...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($submittedLevel < 1 || $submittedLevel > 10) {
        ...
        if ($submittedFlag === $correctFlag) {
            ...
            $message     = 'Incorrect flag. Double-check your PoC and try again.';
            $messageType = 'error';
        }
    }
}
...
if (isset($_GET['clear'])) {
    setcookie('csrf_lab_progress', '', time() - 3600, '/');
...
<head>
    ...
    <title>Submit Flag — CSRF Lab</title>
...
<div class="submit-page">
    ...
    <div class="completion-banner">
        <h2>&#x1F3C6; Lab Complete!</h2>
        <p>You have found all 10 flags. Excellent work — you've demonstrated mastery of Cross-Site Request Forgery and every common (broken) defense.</p>
    </div>
    <?php endif; ?>
    ...
    <div class="progress-section">
        ...
        <div class="flags-list">
            <?php
            $levelTitles = [
                1 => 'No-Token GET State Change',
                2 => 'No-Token POST Form',
                3 => 'Unvalidated CSRF Token',
                4 => 'Static / Predictable Token',
                5 => 'Token Not Bound to Session',
                6 => 'SameSite=Lax Bypass',
                7 => 'JSON Endpoint via text/plain',
                8 => 'Referer Check Bypass',
                9 => 'Double-Submit Cookie Flaw',
                10 => 'Multi-Layer Defense Bypass',
            ];
            for ($i = 1; $i <= 10; $i++):
