...
if (isset($_GET['clear'])) {
    setcookie('nosql_lab_progress', '', time() - 3600, '/');
...
<head>
    ...
    <title>Submit Flag — NoSQL Injection Lab</title>
    ...
    <style>
        ...
        .flag-row.found { border-color: var(--border-hi); background: rgba(255,255,255,0.03); }
...
<div class="submit-page">
    ...
    <div class="completion-banner">
        <h2>&#x1F3C6; Lab Complete!</h2>
        <p>You have found all 10 flags. Excellent work — you've demonstrated mastery of NoSQL injection.</p>
    </div>
    <?php endif; ?>
    ...
    <div class="progress-section">
        ...
        <div class="flags-list">
            <?php
            $levelTitles = [
                1  => 'Auth Bypass via $ne',
                2  => 'Operator via Query String',
                3  => '$gt Filter Bypass',
                4  => '$regex Password Extraction',
                5  => '$in / $or Operator Injection',
                6  => '$where JavaScript Injection',
                7  => 'Blind Boolean Extraction',
                8  => 'Dollar-Keyword Filter Bypass',
                9  => 'Type-Confusion === Bypass',
            ...
            <div class="flag-row <?= $found ? 'found' : '' ?>">
                ...
                <?php else: ?>
                <a href="level<?= $i ?>.php" style="font-size:0.8rem; color:var(--white);">Go &rarr;</a>
                <?php endif; ?>
            </div>
            <?php endfor; ?>
        </div>
