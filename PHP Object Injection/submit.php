...
if (isset($_GET['clear'])) {
    setcookie('poi_lab_progress', '', time() - 3600, '/');
...
<head>
    ...
    <title>Submit Flag — PHP Object Injection Lab</title>
...
<div class="submit-page">
    ...
    <div class="completion-banner">
        <h2>&#x1F3C6; Lab Complete!</h2>
        <p>You have found all 10 flags. Excellent work — you've mastered PHP Object Injection from property tampering to signed-blob WAF bypass.</p>
    </div>
    <?php endif; ?>
    ...
    <div class="progress-section">
        ...
        <div class="flags-list">
            <?php
            $levelTitles = [
                1  => 'Property Injection — isAdmin Bypass',
                2  => '__destruct File-Read Gadget',
                3  => '__wakeup Gadget',
                4  => '__toString Gadget',
                5  => 'POP Chain (Two Gadgets)',
                6  => 'Type-Juggling Auth Bypass',
                7  => '__wakeup Bypass (CVE-2016-7124)',
                8  => 'Phar Deserialization',
                9  => 'RCE POP Chain',
                10 => 'Signed Blob WAF Bypass',
            ];
            for ($i = 1; $i <= 10; $i++):
