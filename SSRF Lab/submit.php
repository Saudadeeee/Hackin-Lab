...
if (isset($_GET['clear'])) {
    setcookie('ssrf_lab_progress', '', time() - 3600, '/');
...
<head>
    ...
    <title>Submit Flag — SSRF Lab</title>
...
<div class="submit-page">
    ...
    <div class="completion-banner">
        <h2>&#x1F3C6; Lab Complete!</h2>
        <p>You have found all 10 flags. Excellent work — you've demonstrated mastery of SSRF attack vectors.</p>
    </div>
    <?php endif; ?>
    ...
    <div class="progress-section">
        ...
        <div class="flags-list">
            ...
            $levelTitles = [
                ...
                3 => 'Blind SSRF',
                4 => 'Host Blocklist Bypass',
                5 => 'Redirect-Based SSRF',
                6 => 'Scheme Abuse: file://',
                7 => 'URL Parser Confusion',
                8 => 'Cloud Metadata Theft',
                9 => 'Hostname Allowlist Bypass',
