...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($submittedLevel < 1 || $submittedLevel > 10) {
        ...
        if ($submittedFlag === $correctFlag) {
            ...
            $message     = 'Incorrect flag. Double-check your payload output and try again.';
            $messageType = 'error';
        }
    }
}
...
if (isset($_GET['clear'])) {
    setcookie('xxe_lab_progress', '', time() - 3600, '/');
...
<head>
    ...
    <title>Submit Flag — XXE Lab</title>
...
<div class="submit-page">
    ...
    <div class="completion-banner">
        <h2>&#x1F3C6; Lab Complete!</h2>
        <p>You have found all 10 flags. Excellent work — you've demonstrated mastery of XXE attack vectors.</p>
    </div>
    <?php endif; ?>
    ...
    <div class="progress-section">
        ...
        <div class="flags-list">
            ...
            <div class="flag-row <?= $found ? 'found' : '' ?>">
                ...
                <span class="flag-title"><?= htmlspecialchars($meta[$i]['title']) ?></span>
                <?php if ($found): ?>
