...
if (isset($_GET['clear'])) {
    setcookie('ssti_lab_progress', '', time() - 3600, '/');
...
<head>
    ...
    <title>Submit Flag — SSTI Lab</title>
...
<div class="submit-page">
    ...
    <div class="completion-banner">
        <h2>&#x1F3C6; Lab Complete!</h2>
        <p>You have found all 10 flags. Excellent work — you've demonstrated mastery of Server-Side Template Injection.</p>
    </div>
    <?php endif; ?>
    ...
    <div class="progress-section">
        ...
        <div class="flags-list">
            ...
            $levelTitles = [
                ...
                2 => 'Variable & Superglobal Access',
                3 => 'Function Call Execution',
                4 => 'Local File Disclosure',
                5 => 'Remote Code Execution',
                6 => 'Keyword Blocklist Bypass',
                7 => 'Character Blocklist Bypass',
                8 => 'Variable-Function Indirection',
                9 => 'Nested Delimiter Bypass',
