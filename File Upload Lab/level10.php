...
<span class="php-keyword">function</span> <span class="php-function">filter_level10</span>(<span class="php-keyword">array</span> <span class="php-variable">$u</span>): <span class="php-keyword">array</span> {
    ...
    <span class="php-keyword">if</span> (<span class="php-function">substr</span>(<span class="php-variable">$u</span>[<span class="php-string">'content'</span>],<span class="php-string">0</span>,<span class="php-string">6</span>) !== <span class="php-string">'GIF89a'</span>)   <span class="php-keyword">return</span> [<span class="php-keyword">false</span>, <span class="php-string">"Layer 3: magic"</span>];
